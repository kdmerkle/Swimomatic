...
if exists (select * from sysobjects where type = 'P' and name = 'usp_HeatSheetEventGet')
	begin
	    drop procedure dbo.usp_HeatSheetEventGet
	end
go

create procedure dbo.usp_HeatSheetEventGet
 /*******************************************************************************************************
 Logical Advantage, LLC
 www.logicaladvantage.com
 704-377-5066
 --------------------------------------------------------------------------------------------------------
 Stored Procedure:	usp_HeatSheetEventGet
...
as
	select
		...
		,hse.Distance
		,hse.HeatSheetID
		,ac.[Description] + ' ' + cast(hse.Distance as varchar) + ' ' + u.[Description] + ' ' + s.[Description] as [Description]
