...
if exists (select * from sysobjects where type = 'P' and name = 'usp_RptHeatSheetEventGetByHeatSheetID')
	begin
	    drop procedure dbo.usp_RptHeatSheetEventGetByHeatSheetID
	end
go

create procedure dbo.usp_RptHeatSheetEventGetByHeatSheetID
 /*******************************************************************************************************
 Logical Advantage, LLC
 www.logicaladvantage.com
 704-377-5066
 --------------------------------------------------------------------------------------------------------
 Stored Procedure:	usp_RptHeatSheetEventGetByHeatSheetID
 
 Description:		Selects a ReportHeatSheetEvent record for the given parameters
 
 --------------------------------------------------------------------------------------------------------
 Change Log:
 v1.0.0 - 11/2/2011  Original Release - Generated by LAAF
 ********************************************************************************************************
