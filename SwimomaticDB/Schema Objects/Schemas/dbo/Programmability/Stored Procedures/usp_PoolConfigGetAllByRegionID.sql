...
if exists (select * from sysobjects where type = 'P' and name = 'usp_PoolConfigGetAllByRegionID')
	begin
	    drop procedure dbo.usp_PoolConfigGetAllByRegionID
	end
go

create procedure dbo.usp_PoolConfigGetAllByRegionID
 /*******************************************************************************************************
 Logical Advantage,pc. LLC
 www.logicaladvantage.com
 704-377-5066
 --------------------------------------------------------------------------------------------------------
 Stored Procedure:	usp_PoolConfigGetAllByRegionID
